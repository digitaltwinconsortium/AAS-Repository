...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ObjectAttributes : IEquatable<ObjectAttributes>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ObjectAttributes)obj);
        }

        /// <summary>
        /// Returns true if ObjectAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of ObjectAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectAttributes other)
        {
            ...
            return
                (
                    ...
                    ObjectAttribute.SequenceEqual(other.ObjectAttribute)
                );
        }
