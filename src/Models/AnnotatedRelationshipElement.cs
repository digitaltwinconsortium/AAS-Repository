...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnnotatedRelationshipElement : RelationshipElement, IEquatable<AnnotatedRelationshipElement>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AnnotatedRelationshipElement)obj);
        }

        /// <summary>
        /// Returns true if AnnotatedRelationshipElement instances are equal
        /// </summary>
        /// <param name="other">Instance of AnnotatedRelationshipElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnotatedRelationshipElement other)
        {
            ...
            return
                (
                    ...
                    Annotation != null &&
                    Annotation.SequenceEqual(other.Annotation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Annotation != null)
                    hashCode = hashCode * 59 + Annotation.GetHashCode();
                return hashCode;
            }
        }
